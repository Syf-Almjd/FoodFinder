                ...
                child: Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image:
                              NetworkImage(widget.meal.strMealThumb ?? "Photo"),
                          fit: BoxFit.fill),
                    ),
                    height: 200.0,
                    width: 200.0))),
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    const SizedBox(width: 10.0),
                    _buildInfoCard(
                        'Ingredient 2', widget.meal.strIngredient2 ?? "2", ''),
                    const SizedBox(width: 10.0),
                    _buildInfoCard(
                        'Ingredient 3', widget.meal.strIngredient3 ?? "3", ''),
                    const SizedBox(width: 10.0),
                    _buildInfoCard(
                        'Ingredient 4', widget.meal.strIngredient4 ?? "4", ''),
                    const SizedBox(width: 10.0),
                    _buildInfoCard(
                        'Ingredient 5', widget.meal.strIngredient5 ?? "5", ''),
                    const SizedBox(width: 10.0),
                    _buildInfoCard(
                        'Ingredient 6', widget.meal.strIngredient6 ?? "6", ''),
                    const SizedBox(width: 10.0),
                  ],
                ),
              ),
